...
def create_entities():
    ...
    TABLE_PATH = os.path.join(BASE_DIR, "src", "pipeline", "workflows", "USGS_Earthquake", "ddl", "tables")
    table_files = [
        "stg_usgs_earthquake.sql",
        "dm_t_usgs_earthquake_fact.sql"
    ]
    ...
    VIEW_PATH = os.path.join(BASE_DIR, "src", "pipeline", "workflows", "USGS_Earthquake", "ddl", "views")
    view_files = [
