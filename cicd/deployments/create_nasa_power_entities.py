...
def create_entities():
    ...
    TABLE_PATH = os.path.join(BASE_DIR, "src", "pipeline", "workflows", "NASA_POWER", "ddl", "tables")
    table_files = [
        "stg_nasa_power_temporal.sql",
        "dm_t_nasa_power_temporal_fact.sql"
    ]
    ...
    # VIEW_PATH = os.path.join(BASE_DIR, "src", "pipeline", "workflows", "NASA_POWER", "ddl", "views")
    # view_files = [
